...
<body id="page-top" class="bg-dark">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <div class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-icon">
                    <img class="icono ms-2" src="{{ asset('images/fondooo.png') }}" alt="">
                </div>
                <div class="sidebar-brand-text">Dalitso Sport</div>
            </div>
                            ...
                            <!-- Dropdown - User Information -->
                                ...
                                aria-labelledby="userDropdown">
                                    <a class="dropdown-item text-dark" href="{{ route('logout') }}"
                                        onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"></i>
                                        Cerrar sesión
                                    </a>
    ...
    <h1 class="text-center mt-4 bg-primary">@yield('titulo')</h1>
