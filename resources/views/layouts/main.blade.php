...
<body class="bg-dark">
    <nav class="navbar navbar-expand-lg">
        <div class="container"> <a class="navbar-brand text-light" href="">Gestión de productos</a>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item dropdown ">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item text-dark" href="{{ route('categorias.index') }}">Ver</a></li>
                            @can(['administrador'])
                                <li><a class="dropdown-item text-dark" href="{{ route('categorias.create') }}">Crear nuevo</a></li>
                            @endcan
                        </ul>
                    </li>
                    <li class="nav-item dropdown ">
